...
class Solution(object):
    # solution 1: Your runtime beats 99.54 % of python submissions
    ...
    '''
    # Solution 2: Your runtime beats 99.54 % of python submissions
    def getIntersectionNode(self, headA, headB):
        """
        ...
        lhead, shead = headA, headB
        if la < lb:
            lhead, shead = headB, headA
